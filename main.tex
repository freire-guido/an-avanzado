...
\begin{teorema}[Representaci\'on de Riesz]
    ...
    \enum{
        \item Unicidad: Sean $t, t' /\; \forall x \in X,\, \langle t - t', x \rangle = 0 \implies \langle t - t', t - t' \rangle = 0$
        \item Existencia \textit{(caso separable)}: Dada $\{e_i\}_{i\in I}$ base ortonormal, $\forall u \in X,\, u = \sum_{i\in I}a_ie_i$
        \begin{align*}
            T(u) &= T(\sum_{i\in I}\langle u, e_i \rangle e_i)\\
                 &= \sum_{i\in I}\langle u, e_i \rangle T(e_i)\\
                 &= \langle u, \sum_{i\in I}T(e_i)e_i \rangle 
        \end{align*}
        Osea que puedo tomar $t = \sum_{i\in I}T(e_i)e_i$
    }
\end{teorema}
